- dashboard: marketing_attribution
  ...
  - title: Purchase Revenue
    ...
    - category: table_calculation
      expression: "${attribution.total_first_order_revenue}+${attribution.total_repeat_order_revenue}"
      label: Purchase Value
      value_format:
      value_format_name: usd_0
      _kind_hint: measure
      table_calculation: purchase_value
      _type_hint: number
    value_labels: legend
    label_type: labPer
    color_application:
  ...
  - title: Purchases by Attribution Model
    ...
    dynamic_fields:
    - category: table_calculation
      expression: "${attribution.total_first_order_conversions}+${attribution.total_repeat_order_conversions}"
      label: Total Purchases
      value_format:
      value_format_name: decimal_0
      _kind_hint: measure
      table_calculation: total_purchases
      _type_hint: number
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
  ...
  - title: Repeat Purchases
    ...
    - category: table_calculation
      ...
      _type_hint: number
    - category: table_calculation
      expression: "${total_purchases}/sum(pivot_row(${total_purchases}))"
      label: "% of Total Purchases"
      value_format:
      value_format_name: percent_0
      _kind_hint: measure
      table_calculation: of_total_purchases
      _type_hint: number
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
